...
public class ExchangeDealSourceExtendedMapping extends AbstractMappingExtended<ExchangeDealSourceExtended> {
    public ExchangeDealSourceExtendedMapping() {
        super("public", "exchangeDealsSource");

        mapUUID(MappingConstants.UPLOAD_KEY, ExchangeDealSourceExtended::getUploadKey);
