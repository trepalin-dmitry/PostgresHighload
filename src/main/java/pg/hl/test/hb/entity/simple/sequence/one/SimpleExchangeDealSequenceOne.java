...
@Table(name = "simpleExchangeDealsSequenceOne")
@ToString(onlyExplicitlyIncluded = true)
public class SimpleExchangeDealSequenceOne implements HibernateRootEntity {
    private static final String SEQUENCE_NAME = "simple_exchange_deals_sequence_one_id_seq";
